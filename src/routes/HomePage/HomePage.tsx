...
const description =
  "That next.js starter demonstrates consistently fast navigation via optimistic UI. Navigation stays responsive regardless of the Internet speed or CPU performance.";
      ...
      <Container>
        ...
        <div className="prose lg:prose-xl dark:prose-invert max-w-2xl">
          ...
          <code>
            Powered by{" "}
            <a
              href="https://github.com/ilkinsufi/next-query-glue"
              target="_blank"
            >
              next-query-glue
            </a>{" "}
            and{" "}
            <a href="https://github.com/TanStack/query" target="_blank">
              TanStack Query
            </a>
            .
          </code>

          <p>{description} Click on any card below to see it.</p>
        </div>
